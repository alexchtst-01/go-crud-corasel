...
const QuickLinks = () => {
  ...
  const menuItems = [
    { icon: <Home size={20} />, label: 'Home', dropdown: ['Pilihan 1', 'Sublink 2'] },
    { icon: <Database size={20} />, label: 'Database', dropdown: ['Sublink 1', 'Sublink 2'] },
    { icon: <Monitor size={20} />, label: 'Info', dropdown: ['Sublink 1', 'Sublink 2'] },
